$(document).ready(function(){
	...
	$('#note-submit').live('click',function(e){
		...
		$(this).replaceWith('<img src="../notes/img/ajax_load.gif" style="margin:30px auto;display:block" />');
		...
		$.post('../notes/ajax/post.php',data,function(msg){
	...
	$('a').live('click',function(){
		...
		$("#"+ note_id).hide();
		var tmp_arr = note_id.split("_");
		$.post('../notes/ajax/delete.php',{id:tmp_arr[1]});
	});
});
...
function make_draggable(elements)
{
	...
	elements.draggable({
		...
		stop:function(e,ui){
			...
			$.get('../notes/ajax/update_position.php',{
				  x		: ui.position.left,
				  y		: ui.position.top,
				  z		: zIndex,
